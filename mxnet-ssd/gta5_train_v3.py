...
str_args+=' --gpus 0 1 2 3'

batch_size=str(int(1*batch_per_gpu))
str_args+=' --batch-size '+batch_size

train_path='../data/train_v3.rec'
str_args+=' --train-path '+train_path

valid_path='../data/train_v3.rec'
str_args+=' --val-path '+valid_path


prefix='../params/gta5_2d_v3'
str_args+=' --prefix '+prefix

str_args+=' --num-class '+str(2)
str_args+=' --class-names '+'0,1'
